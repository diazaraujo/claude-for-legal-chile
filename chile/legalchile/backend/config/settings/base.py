...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "legalchile_db"),
        "USER": os.environ.get("POSTGRES_USER", "legalchile_user"),
...
# Corpus jurídico: índices FTS5 SQLite del pipeline (chile/data/_index/). Solo lectura.
