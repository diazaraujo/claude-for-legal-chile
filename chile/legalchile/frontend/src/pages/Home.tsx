// Portado del landing estático Decide (claude-legal-chile-site). Look-and-feel intacto.
...
export default function Home() {
  return (
    <div className="decide-root">
      ...
      <header className="nav">
        <div className="wrap">
          <a href="#" className="brand">
            ...
            <span className="sub">· Derecho chileno real</span>
          </a>
      ...
      {/* HERO · header compacto estilo dashboard */}
      <section className="hero">
        <div className="wrap">
          <div className="toprow">
            <span className="section-tag">Claude Legal Chile · Derecho chileno real</span>
            <span className="status"><span className="dot"></span> Cero citas inventadas · corpus verificable</span>
          </div>
          ...
          <div className="cta">
            <a className="btn btn-primary" href="#participar">Quiero probarlo</a>
            <a className="btn btn-ghost" href="#corpus">Ver el corpus</a>
            <a className="btn btn-ghost" href="#capacidades">Capacidades</a>
            <a className="btn btn-ghost" href="#comparativa">Antes / después</a>
          </div>
        </div>
      </section>
      ...
      {/* ¿QUÉ ES? · documentación consolidada del proyecto */}
      ...
      <section className="blk" id="analitica">
        <div className="wrap">
          <div className="sec-head">
            ...
            <p>El corpus no sirve solo para citar. Sobre los 3,3M de fallos se pueden extraer —con modelos de lenguaje sobre el texto de cada sentencia— los montos, materias, jueces y resultados de cada causa, y construir analítica del comportamiento real de la justicia. Estas son las preguntas que esa capa permite responder con datos del corpus, no con teoría:</p>
          </div>
          <div className="agrid">
          ...
          <div className="qchips">
            <div className="qchips-h">Preguntas que esta capa permite responder sobre datos del corpus</div>
            <div className="chips">
              <span>¿Qué proporción del monto demandado se suele acoger en esta materia?</span>
              <span>¿Cuánto demora una causa en este juzgado, en promedio y mediana?</span>
              <span>¿Qué materias tienen mayor probabilidad de ser acogidas?</span>
              <span>¿Conviene ir a sentencia o buscar avenimiento / conciliación?</span>
              <span>¿Cómo es la tendencia histórica de fallo de este juez o juzgado?</span>
              <span>¿Cómo litiga esta empresa: pelea en tribunal o transa?</span>
              <span>¿Cómo se distribuyen las materias en los ingresos de causas?</span>
              <span>¿Qué montos se solicitan típicamente en este tipo de demanda?</span>
              <span>¿En cuántas cuotas suelen pactarse los avenimientos?</span>
              <span>¿Cómo evolucionó el criterio sobre esta materia en el tiempo?</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="ctaband">
            ...
            <div className="cta" style={{ justifyContent: 'center' }}>
              <a className="btn btn-primary" href="mailto:antonio@unholster.com?subject=Quiero%20probar%20Claude%20Legal%20Chile&body=Hola%2C%20me%20interesa%20probar%20el%20asistente.%20Mi%20%C3%A1rea%20de%20pr%C3%A1ctica%20es%3A%20"><svg className="ic"><path d="M22 6 12 13 2 6M2 6h20v12H2z"/></svg> Sumarme a probar</a>
        ...
        <div className="wrap cols">
          <div className="f-brand">
            <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}>
              <span className="brand"><span className="logo" style={{ height: '16px' }}><span style={{ height: '7px' }}></span><span style={{ height: '11px' }}></span><span style={{ height: '16px' }}></span></span></span>
              <b>Claude Legal Chile</b>
            </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li><a href="#comparativa">Antes / después</a></li>
              <li><a href="#analitica">Análisis de tribunales</a></li>
              <li><a href="#corpus">El corpus</a></li>
              <li><a href="#pipeline">El recorrido de la data</a></li>
